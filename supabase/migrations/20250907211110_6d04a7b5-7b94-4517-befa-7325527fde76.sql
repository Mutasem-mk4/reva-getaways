-- DATABASE OPTIMIZATION FOR BETTER USABILITY
-- Adding foreign keys, indexes, and utility functions

-- 1) ADD FOREIGN KEY CONSTRAINTS
-- Add foreign key from farm_images to farms
...
-- Function to get farm statistics (images count, availability percentage)
...
-- When the first image is uploaded, automatically set it as primary
