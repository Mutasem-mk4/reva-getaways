...
export const ShinyButton: React.FC<ShinyButtonProps> = ({ children, className, onClick, type, disabled }) => {
  return (
    <motion.button
      initial={{ "--x": "100%", scale: 0.8 } as any}
      animate={{ "--x": "-100%", scale: 1 } as any}
    ...
    >
      <span
        className="relative block w-full text-sm uppercase tracking-wide text-[rgb(0,0,0,0.65)] dark:font-light dark:text-[rgb(255,255,255,0.9)]"
        style={{
          maskImage:
